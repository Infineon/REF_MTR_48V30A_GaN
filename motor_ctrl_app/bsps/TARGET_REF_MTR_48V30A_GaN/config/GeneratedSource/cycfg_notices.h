...
#if !defined(XMC4200_Q48x256)
#error "Unexpected MPN; expected DEVICE:=XMC4200-Q48x256. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(XMC4200_Q48x256) */
