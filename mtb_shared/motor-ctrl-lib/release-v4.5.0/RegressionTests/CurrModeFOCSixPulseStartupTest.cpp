...
TEST_GROUP(CurrModeFOCSixPulseStartupTest)
{
    CSysSim* sys_sim;

    const ELEC_t Initial_Angle = { DEG_TO_RAD(-125.0f) }; // [Ra-elec]
    ...
    void setup()
    {
        ...
        params.ctrl.mode = Curr_Mode_FOC_Sensorless_SixPulse_Startup; // [#]
...
TEST(CurrModeFOCSixPulseStartupTest, ClosedLoopPositiveCurrntCmd)
{
...
TEST(CurrModeFOCSixPulseStartupTest, ClosedLoopNegativeCurrntCmd)
{
