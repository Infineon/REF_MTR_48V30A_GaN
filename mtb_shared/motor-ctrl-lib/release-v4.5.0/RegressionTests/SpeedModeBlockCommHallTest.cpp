...
TEST_GROUP(SpeedModeBlockCommHallTest)
{
    CSysSim* sys_sim;
...
TEST(SpeedModeBlockCommHallTest, ClosedLoopWithCurrCtrlPositiveSpeedCmd)
{
    ...
    ANGLE_EQUAL(sys_sim->m_bldc.m_th_r.elec, sm.vars.capture_vals[1], DEG_TO_RAD(15.0f)); // vars.th_r_hall.elec
...
TEST(SpeedModeBlockCommHallTest, ClosedLoopWithCurrCtrlNegativeSpeedCmd)
{
    params.ctrl.curr.bypass = false;
    PARAMS_DEFAULT_InitAutoCalc();
    STATE_MACHINE_Init();
...
TEST(SpeedModeBlockCommHallTest, ClosedLoopBypassCurrCtrlPositiveSpeedCmd)
{
    params.ctrl.curr.bypass = true;
    PARAMS_DEFAULT_InitAutoCalc();
    STATE_MACHINE_Init();
...
TEST(SpeedModeBlockCommHallTest, ClosedLoopBypassCurrCtrlNegativeSpeedCmd)
{
    params.ctrl.curr.bypass = true;
    PARAMS_DEFAULT_InitAutoCalc();
    STATE_MACHINE_Init();
