...
TEST_GROUP(SpeedModeFOCAlignStartupTest)
{
    CSysSim* sys_sim;
    ...
    void setup()
    {
        ...
        params.ctrl.mode = Speed_Mode_FOC_Sensorless_Align_Startup;
...
TEST(SpeedModeFOCAlignStartupTest, ClosedLoopPositiveSpeedCmd)
{
...
TEST(SpeedModeFOCAlignStartupTest, ClosedLoopNegativeSpeedCmd)
{
