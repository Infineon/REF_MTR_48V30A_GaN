...
TEST_GROUP(SpeedModeFOCHighFreqStartupTest)
{
    CSysSim* sys_sim;
...
TEST(SpeedModeFOCHighFreqStartupTest, ClosedLoopPositiveSpeedCmd)
{
...
TEST(SpeedModeFOCHighFreqStartupTest, ClosedLoopNegativeSpeedCmd)
{
