...
TEST_GROUP(TrqModeFOCSixPulseStartupTest)
{
    CSysSim* sys_sim;
    ...
    void setup()
    {
        ...
        params.ctrl.mode = Trq_Mode_FOC_Sensorless_SixPulse_Startup; // [#]
...
TEST(TrqModeFOCSixPulseStartupTest, ClosedLoopPositiveTorqueCmd)
{
...
TEST(TrqModeFOCSixPulseStartupTest, ClosedLoopNegativeTorqueCmd)
{
